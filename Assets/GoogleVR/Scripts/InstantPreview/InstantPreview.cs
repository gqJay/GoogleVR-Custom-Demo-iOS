...
//					Debug.LogError("gq update camera");
//                    eyeCamera.leftEyeCamera.cullingMask = ~(1 << LayerMask.NameToLayer("Right"));
//                    eyeCamera.rightEyeCamera.cullingMask = ~(1 << LayerMask.NameToLayer("Left"));
        ...
        void EnsureEyeCamera(Camera mainCamera, String eyeCameraName, Rect rect, ref Camera eyeCamera)
        {
            ...
            // if (eyeCameraName.ToLower().Contains("left"))
            // {
            //     eyeCamera.cullingMask = ~(1 << LayerMask.NameToLayer("Right"));
            //     //eyeCamera.stereoTargetEye = StereoTargetEyeMask.Left;
            // }
            // else
            // {
            //     eyeCamera.cullingMask = ~(1 << LayerMask.NameToLayer("Left"));
            //     //eyeCamera.stereoTargetEye = StereoTargetEyeMask.Right;
            // }
